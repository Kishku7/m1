...
$repo=Split-Path -Parent $MyInvocation.MyCommand.Path; $fabric=Join-Path $repo "Fabric\26"; $dist=Join-Path $repo "dist"
...
$matrix=[ordered]@{
  ...
  "26.3"=@{mc="26.3-snapshot-1"; api="0.153.1+26.3";   loader="0.19.3"; dep=">=26.3- <26.4"; pf="89"}
}
