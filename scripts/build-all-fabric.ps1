...
$matrix=[ordered]@{
  "26.1"=@{mc="26.1.2";          api="0.155.3+26.1.2"; loader="0.19.5"; dep=">=26.1- <26.2"; pf="84"}
  "26.2"=@{mc="26.2";            api="0.160.0+26.2";   loader="0.19.5"; dep=">=26.2- <26.3"; pf="88"}
  "26.3"=@{mc="26.3";            api="0.160.7+26.3";   loader="0.19.5"; dep=">=26.3- <26.4"; pf="97"}
}
