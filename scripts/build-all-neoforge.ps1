...
$matrix=[ordered]@{
  "26.1"=@{mc="26.1.2"; neo="26.1.2.109"; mcRange="[26.1,26.2)"; neoRange="[26.1.0-alpha,)"; pf="84"}
  "26.2"=@{mc="26.2";   neo="26.2.0.88";  mcRange="[26.2,26.3)"; neoRange="[26.2.0-alpha,)"; pf="88"}
  "26.3"=@{mc="26.3";   neo="26.3.0.4-beta";   mcRange="[26.3,26.4)"; neoRange="[26.3.0-alpha,)"; pf="97"}
}
